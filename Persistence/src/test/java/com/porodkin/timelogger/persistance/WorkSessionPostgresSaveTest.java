...
class WorkSessionPostgresSaveTest {

    @Mock
    private PostgresRepositoryJpa repository;

    @InjectMocks
    private WorkSessionPostgresSave workSessionPostgresSave;
    ...
    void testSaveWorkSession() {
        ...
        try (MockedStatic<WorkTimeToWorkSessionMapper> mockedMapper = mockStatic(WorkTimeToWorkSessionMapper.class)) {
            ...
            // Act
            WorkSession result = workSessionPostgresSave.saveWorkSession(inputWorkSession);
